...
class OccupancyGridParser(Node):
    def __init__(self) -> None:
        ...
        self.create_subscription(OccupancyGrid, '/obstacle_detection/dilated_positive_obstacle_grid', self.occupancy_grid_callback, 10)
    ...
    def cluster_points(self, points: np.ndarray[float], resolution: float) -> List[np.ndarray[float]]:
        ...
        """
        clustering: DBSCAN = DBSCAN(eps=resolution, min_samples=2).fit(points)
